...
class ORMViewController: UIViewController, UITextFieldDelegate{
    ...
    override func viewDidLoad() {
        ...
        ormReaction.font = UIFont(name: "HelveticaNeue-Light", size: 16)
    ...
    @objc func keyboardWillShow(_ notification: Notification) {
        ...
        if let activeTextField = activeTextField {
            ...
            if textFieldFrame.origin.y + textFieldFrame.height > visibleAreaHeight {
                ...
                ORMLabel.isHidden = true
                ormReaction.isHidden = true
            }
        }
    }
    ...
    @objc func keyboardWillHide(_ notification: Notification) {
        ...
        ORMLabel.isHidden = false
        ormReaction.isHidden = false
    }
